...
#define kSinaWeiboSDKAPIDomain             @"http://www.oschina.net/"
#define kSinaWeiboSDKOAuth2APIDomain       @"http://www.oschina.net/action/oauth2/"
#define kSinaWeiboWebAuthURL               @"http://www.oschina.net/action/oauth2/authorize"
#define kSinaWeiboWebAccessTokenURL        @"http://www.oschina.net/action/openapi/token"
